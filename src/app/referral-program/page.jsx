      ...
      <div className="flex mb-10 flex-col items-left justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="p-4 border border-black/20 rounded-lg">
            ...
            <p className="text-gray-500 sm:text-base text-sm">Get a 2% commission when your referred member purchases a Bhumap&aposs property.</p>
          </div>

          <div className="p-4 border border-black/20 rounded-lg">
            <i className="bx bx-heart text-primary text-3xl"></i>
            <h2 className="mb-2 font-semibold sm:text-lg">Repeat & Earn!</h2>
            <p className="text-gray-500 sm:text-base text-sm">Get these rewards every time your referral buys a membership plan or purchases a Bhumap&aposs property.</p>
          </div>
        </div>
